/*****************************************************************************
// File Name : DampAngleSmootherDebug.cs
// Author : Brandon Koederitz
// Creation Date : May 14, 2025
//
// Brief Description : Copy script to debug the Mathf.SmoothDampAngle function that was causing a NaN Error.
*****************************************************************************/
...
{
    public class DampAngleSmootherDebug : MonoBehaviour
    {
            ...
            [DefaultValue("Mathf.Infinity")] float maxSpeed, [DefaultValue("Time.deltaTime")] float deltaTime)
        {
            ...
            // Right part of the if statement checks for if our new angle has exceeded the target angle based on the
            // direction we're moving determined by the left statement.
